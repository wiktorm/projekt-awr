...
* @version $Id: admin_reference_language.php 952 2010-03-05 14:11:00Z beat $
...
'First sub-menu name. Leave empty to not appear.' => 'First sub-menu name. Leave empty to not appear.',
...
'Checking Community Builder Datbase' => 'Checking Community Builder Datbase',
...
'Checking Users Datbase' => 'Checking Users Datbase',
...
'Following entries of core_acl_aro table are missing in users table: %s.' => 'Following entries of core_acl_aro table are missing in users table: %s.',
...
'All ACL core_acl_aro table rows have corresponding entries in users table.' => 'All ACL core_acl_aro table rows have corresponding entries in users table.',
...
'The plugin %s has no administrator file $phpfile' => 'The plugin %s has no administrator file $phpfile',
...
// .../administrator/components/com_comprofiler/toolbar.comprofiler.html.php (57 in CBTxt format) //
'Please make a selection from the list to %s' => 'Please make a selection from the list to %s',
'Please make a selection from the list to publish' => 'Please make a selection from the list to publish',
'Please select an item to make default' => 'Please select an item to make default',
'Please select an item to assign' => 'Please select an item to assign',
