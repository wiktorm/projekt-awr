...
?>
<form class="attachmentsBackend" action="index.php" method="post" <?php echo $enctype ?> name="adminForm" id="adminForm">
<fieldset class="adminform">
<legend><?php echo JText::_('DETAILS'); ?></legend>
<table class="admintable">
  <tr><td class="key"><?php echo JText::_('ATTACHMENT_ID_COLON'); ?></td>
...
<?php if ( $this->change_parent ): ?>
	  ...
	  <td><input id="parent_title" value="<?php echo $this->selpar_parent_title; ?>"
...
<?php else: ?>
	  <td class="key"><?php echo
	   ...
	   <td><?php if ( $attachment->parent_id == null ) {
...
<?php endif; ?>
  ...
  <td><?php echo JText::_(JString::strtoupper($uri_type));?>
...
<?php if ( $update == 'file' ): ?>
  <tr>
	  <td class="key"><label for="<?php echo $update_id; ?>"></label></td>
	  <td><b><?php echo JText::_('SELECT_NEW_FILE_IF_YOU_WANT_TO_UPDATE_ATTACHMENT_FILE') ?></b>
 <br />
...
<?php else: ?>
  ...
  <tr><td class="key"><?php echo JText::_('SYSTEM_FILENAME'); ?></td>
	  <td><?php echo $attachment->filename_sys; ?></td>
  </tr>
...
<?php if ( $update == 'file' OR $uri_type == 'file' ): ?>
  ...
  <tr><td class="key"><label for="display_name"
	  ...
	  <td><input class="text" type="text" name="display_name"
...
<?php endif; ?>
  ...
  <tr><td class="key"><?php echo JText::_('FILE_TYPE_COLON'); ?></td>
	  <td><?php echo $attachment->file_type; ?></td>
  </tr>
  <tr><td class="key"><?php echo JText::_('FILE_SIZE_COLON'); ?></td>
	  <td><?php echo $attachment->size; ?> <?php echo JText::_('KB'); ?></td>
  </tr>
  <tr><td class="key"><?php echo JText::_('UPLOADER_NAME'); ?></td>
  ...
  ?>
  <tr><td class="key" title="<?php echo $tooltip; ?>"><?php echo JText::_('NUMBER_OF_DOWNLOADS'); ?>:</td>
