...
#ProgressBar #progressStepDone {
    background-color: #fd6704;
    border: thin solid #ddd;
}

#ProgressBar #progressStepToGo {
    background-color: #eee;
    border: thin solid #ddd;
}
</style>
<script type="text/javascript">
	...
	function updateStep(description, percentComplete) {
		var progressMade = Math.round(percentComplete * 100);
		var progressStepToGo = document.getElementById('progressStepToGo');
		
		if (progressMade == 100) {
			 progressStepToGo.style.display = 'none'; 
		} else {
			 progressStepToGo.style.display = 'inline-block';
			 progressStepToGo.style.width = (100 - progressMade) + "%";
		}
		document.getElementById('progressStepDone').style.width = progressMade + "%";
		document.getElementById('progressStepDescription').innerHTML = description;
	}
</script>
</head>
<body>
<div id="progressBar" class="block">
	...
	<p id="progressStepDescription">
		&nbsp;
	</p>
		
	<table width="80%" cellspacing="0" cellpadding="0">
		<tr>
			<td id="progressStepDone" style="display: inline-block; width:0%">&nbsp;</td>
		    <td id="progressStepToGo" style="display: inline-block; width:100%; border-left: none">&nbsp;</td>
		</tr>
	</table>
