...
* @version $Id: toolbar.comprofiler.html.php 897 2010-02-27 12:14:04Z beat $
...
class TOOLBAR_usersextras {
	...
	*/
	...
	function _DEFAULT_PLUGIN_MENU() {
		CBtoolmenuBar::startTable();
		CBtoolmenuBar::linkAction( 'cancel', 'index2.php?option=com_comprofiler&task=showPlugins', 'Close' );
		CBtoolmenuBar::endTable();
	}
