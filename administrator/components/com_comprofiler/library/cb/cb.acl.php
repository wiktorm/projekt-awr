<?php
/**
* @version $Id: cb.acl.php 831 2010-01-26 11:04:24Z beat $
 ...
 */
	 ...
	 *
	 * @param  int    $uid              userid  !!! WARNING: up to CB 1.2.1: param was &$uid : if is 0 it will assign $_CB_framework->myId() to it !!!
